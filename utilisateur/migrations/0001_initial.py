    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(choices=[(1, 'Free'), (2, 'Basic'), (3, 'Premium')], default=1)),
                ('date_debut', models.DateField(auto_now_add=True)),
                ('date_expiration', models.DateField()),
                ('active', models.BooleanField(default=True)),
                ('code', models.CharField(editable=False, max_length=14, unique=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Admin'), (2, 'Editor'), (3, 'Author'), (4, 'Visitor')], null=True)),
